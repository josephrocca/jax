...
"""A small module for interoperable logging between ABSL and Python in JAX."""
import importlib
...
import logging
logging.addLevelName(9, "CPP_ERROR")
logging.addLevelName(8, "CPP_CRITICAL")
del logging
...
def vlog_is_on(level: int, name: Optional[str] = None):
  ...
  For example, when using absl C++ logging, the level should be an
  integer between 0 (debug/info) and 3 (critical/fatal), while for Python
  builtin logging, it should be between 10 (debug) and 50 (critical/fatal).
